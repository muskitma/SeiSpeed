...
#[derive(Debug)]
pub struct SeiSpeedProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SeiSpeedProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SeiSpeed processing");
    
    let mut processor = SeiSpeedProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SeiSpeedProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SeiSpeedProcessor::new(false);
